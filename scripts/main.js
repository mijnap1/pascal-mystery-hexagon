    ...
    const copy = {
      en: {
        ...
        outroSubtitle: "The construction closes on a single straight line. The links below serve as the references and citations for this page.",
      ...
      ko: {
        ...
        outroSubtitle: "마지막에는 세 교점이 하나의 직선 위에 놓입니다. 아래 목록은 이 페이지에서 참고한 출처와 인용 자료입니다.",
        restart: "튜토리얼 다시 보기",
        home: "홈으로 돌아가기",
        randomize: "점 배치 바꾸기",
